...
public class Paddygovtinsert1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paddygovtinsert1);
        ...
        fbase.setAndroidContext(Paddygovtinsert1.this);
        fbaseauth = FirebaseAuth.getInstance();


        btnsetdate.setOnClickListener(Paddygovtinsert1.this);
        ...
        btnsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fbase = new Firebase("https://demokmp.firebaseio.com/PADDYGOVTPURCHASEINSERT_DETAILS/" + uname);
                if (TextUtils.isEmpty(email)) {
                    Toast.makeText(Paddygovtinsert1.this, "தயவுசெய்து உங்கள் மின்னஞ்சல் முகவரியை கொடுக்கவும் ", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(pname)) {
                    Toast.makeText(Paddygovtinsert1.this, "தயவுசெய்து நெல் பெயரை உள்ளிடவும் ", Toast.LENGTH_SHORT).show();
                 } else if (TextUtils.isEmpty(uname)) {
                  Toast.makeText(Paddygovtinsert1.this, "தயவுசெய்து உங்கள் பெயரைக் கொடுங்கள் ", Toast.LENGTH_SHORT).show();
                 } else if (TextUtils.isEmpty(uad)) {
                Toast.makeText(Paddygovtinsert1.this, "உங்கள் நிரந்தர முகவரியை கொடுக்கவும் ", Toast.LENGTH_SHORT).show();
                  } else if (TextUtils.isEmpty(date)) {
                  Toast.makeText(Paddygovtinsert1.this, "தயவு செய்து உங்கள் நெல் வாங்கிய தேதி உள்ளிடவும் ", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(backet)) {
                Toast.makeText(Paddygovtinsert1.this, "உங்கள் மொத்த நெல் கிலோவை உள்ளிடவும் ", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(hect)) {
                    Toast.makeText(Paddygovtinsert1.this, "உங்கள் மொத்த ஹெக்டேர் உள்ளிடவும் ", Toast.LENGTH_SHORT).show();
                 } else if (TextUtils.isEmpty(pno)) {
                Toast.makeText(Paddygovtinsert1.this, "உங்கள் செல்லுபடியாகும் தொலைபேசி எண்ணை கொடுங்கள் ", Toast.LENGTH_SHORT).show();
                } else if (TextUtils.isEmpty(tot)) {
                Toast.makeText(Paddygovtinsert1.this, "தயவுசெய்து உங்கள் தொகை சேர்க்கவும் ", Toast.LENGTH_SHORT).show();
                } else {
                    m = new HashMap<>();
                    m.put("Email", email);
                    ...
                    fbase.setValue(m);
                    Toast.makeText(Paddygovtinsert1.this, "பதிவு ஏற்றுக்கொள்ளப்பட்டது ", Toast.LENGTH_LONG).show();
                    sendmessage();
        ...
        btncancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent i = new Intent(Paddygovtinsert1.this, Paddysalesstation.class);
                startActivity(i);
            }
        });
