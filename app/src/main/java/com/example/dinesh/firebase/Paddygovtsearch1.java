...
public class Paddygovtsearch1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paddygovtsearch1);
    ...
    public void search() {
        ...
        firebase = new Firebase("https://demokmp.firebaseio.com/PADDYGOVTPURCHASEINSERT_DETAILS/");
